    ...
    <header class="header">
        <div class="container flex-between">
            ...
            <nav class="nav-desktop">
                ...
                <a href="<?php echo e(route('home')); ?>#propos" class="nav-link">
                    <i class="fas fa-info-circle"></i> À propos
                </a>
                <a href="<?php echo e(route('guide')); ?>" class="nav-link active">
        ...
        <div class="mobile-menu" id="mobileMenu">
            ...
            <div class="mobile-menu-content">
                ...
                <a href="<?php echo e(route('home')); ?>#propos" class="mobile-nav-link">
                    <i class="fas fa-info-circle"></i> À propos
                </a>
                <a href="<?php echo e(route('guide')); ?>" class="mobile-nav-link active">
                    <i class="fas fa-book"></i> Guide
                </a>
        ...
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-links">
                    ...
                    <a href="<?php echo e(route('home')); ?>#propos">À propos</a>
...
<?php /**PATH /home/espoir/larav/resources/views/guide.blade.php ENDPATH**/ ?>