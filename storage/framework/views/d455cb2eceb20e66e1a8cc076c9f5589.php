...
<div class="proprio-paiements-page">
    ...
    <div class="page-header">
        ...
        <div class="export-dropdown">
            ...
            <div class="export-menu" id="exportMenu">
                <a href="<?php echo e(route('proprietaire.paiements.exporter.pdf', ['periode' => 'mois'])); ?>" class="export-item">
                    <span class="item-icon">📄</span>
                    <span class="item-text">Exporter ce mois</span>
                </a>
                <a href="<?php echo e(route('proprietaire.paiements.exporter.pdf', ['periode' => 'trimestre'])); ?>" class="export-item">
                    <span class="item-icon">📅</span>
                    <span class="item-text">Exporter 3 derniers mois</span>
                </a>
                <a href="<?php echo e(route('proprietaire.paiements.exporter.pdf', ['periode' => 'annee'])); ?>" class="export-item">
                    <span class="item-icon">📊</span>
    ...
    <div class="filters-section">
        ...
        <form method="GET" action="<?php echo e(route('proprietaire.paiements')); ?>" class="filters-form">
            <div class="filters-grid">
                ...
                <div class="filter-group">
                    ...
                    <select name="locataire_id" id="locataire_id" class="filter-select">
                        ...
                        <?php $__currentLoopData = $filtres['locataires'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locataire): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($locataire->id); ?>" <?php echo e(request('locataire_id') == $locataire->id ? 'selected' : ''); ?>>
                            <?php echo e($locataire->nom); ?>
                ...
                <div class="filter-group">
                    ...
                    <select name="type_bien" id="type_bien" class="filter-select">
                        ...
                        <option value="maison" <?php echo e(request('type_bien') == 'maison' ? 'selected' : ''); ?>>Maisons</option>
                        <option value="appartement" <?php echo e(request('type_bien') == 'appartement' ? 'selected' : ''); ?>>Appartements</option>
                    </select>
                </div>
                ...
                <div class="filter-group">
                    ...
                    <select name="periode" id="periode" class="filter-select">
                        ...
                        <option value="mois" <?php echo e(request('periode') == 'mois' ? 'selected' : ''); ?>>Ce mois</option>
                        <option value="trimestre" <?php echo e(request('periode') == 'trimestre' ? 'selected' : ''); ?>>3 derniers mois</option>
                        <option value="annee" <?php echo e(request('periode') == 'annee' ? 'selected' : ''); ?>>Cette année</option>
                    </select>
                </div>
                ...
                <div class="filter-actions">
                    ...
                    <a href="<?php echo e(route('proprietaire.paiements')); ?>" class="btn-secondary">
            ...
            <div class="payment-card">
                <div class="payment-header">
                    <div class="payment-ref">
                        <span class="ref-number">#<?php echo e(str_pad($paiement->id, 6, '0', STR_PAD_LEFT)); ?></span>
                        <span class="payment-date"><?php echo e($paiement->created_at->format('d/m/Y à H:i')); ?></span>
                    </div>
                    <div class="payment-actions-header">
                        <span class="badge badge-success"><?php echo e(ucfirst($paiement->statut ?? 'payé')); ?></span>
                        <a href="<?php echo e(route('proprietaire.paiements.recu', $paiement->id)); ?>" class="btn-receipt" title="Télécharger le reçu">
                            <span class="btn-icon">📄</span>
                            <span>Reçu</span>
                        </a>
                    </div>
                        ...
                        <div class="info-block">
                            ...
                            <div class="info-details">
                                <div class="info-row">
                                    ...
                                    <span class="info-value"><?php echo e($paiement->utilisateur->nom ?? 'N/A'); ?></span>
                                </div>
                                <div class="info-row">
                                    <span class="info-label">Email :</span>
                                    <span class="info-value"><?php echo e($paiement->utilisateur->email ?? 'N/A'); ?></span>
                                </div>
                                <?php if($paiement->utilisateur->telephone ?? false): ?>
                                <div class="info-row">
                                    <span class="info-label">Téléphone :</span>
                                    <span class="info-value"><?php echo e($paiement->utilisateur->indicatif_pays ?? ''); ?> <?php echo e($paiement->utilisateur->telephone ?? ''); ?></span>
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="info-block">
                            ...
                            <div class="info-details">
                                <div class="info-row">
                                    ...
                                    <span class="info-value amount"><?php echo e(number_format($paiement->montant, 0, ',', ' ')); ?> FCFA</span>
                                </div>
                                <div class="info-row">
                                    <span class="info-label">Bien :</span>
                                    <span class="info-value">
                                        <?php if($paiement->maison): ?>
                                            Maison : <?php echo e($paiement->maison->nom ?? 'N/A'); ?>

                                        <?php elseif($paiement->appartement): ?>
                                            Appartement n°<?php echo e($paiement->appartement->numero_appartement ?? 'N/A'); ?>
                                ...
                                <div class="info-row">
                                    ...
                                    <span class="info-value"><?php echo e($paiement->operateur->nom ?? 'Mobile Money'); ?></span>
                                </div>
                                <?php if($paiement->reference_transaction): ?>
                                <div class="info-row">
                                    <span class="info-label">Référence :</span>
                                    <span class="info-value ref"><?php echo e($paiement->reference_transaction); ?></span>
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
...
<div id="customExportModal" class="modal-overlay">
    <div class="modal modal-sm">
        ...
        <div class="modal-body">
            <form id="exportForm" method="GET" action="<?php echo e(route('proprietaire.paiements.exporter.pdf')); ?>">
...
<?php echo $__env->make('layouts.proprietaire', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/espoir/larav/resources/views/proprietaire/paiement.blade.php ENDPATH**/ ?>