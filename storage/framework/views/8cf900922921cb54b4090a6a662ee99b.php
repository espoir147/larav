...
<div class="proprio-locataires-page">
    ...
    <div class="stats-grid">
        <div class="stat-card">
            ...
            <div class="stat-content">
                ...
                <p class="stat-number"><?php echo e($locataires->count()); ?></p>
        ...
        <div class="stat-card">
            ...
            <div class="stat-content">
                ...
                <p class="stat-number"><?php echo e(number_format($loyersMensuels ?? 0, 0, ',', ' ')); ?> FCFA</p>
                <div class="stat-details">
        ...
        <div class="stat-card">
            ...
            <div class="stat-content">
                ...
                <p class="stat-number"><?php echo e($paiementsAJour ?? 0); ?></p>
                <div class="stat-details">
                    <span class="detail-item">sur <?php echo e($locataires->count()); ?> locataires</span>
                </div>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-content">
                <h3>En retard</h3>
                <p class="stat-number"><?php echo e(($locataires->count() - ($paiementsAJour ?? 0))); ?></p>
                <div class="stat-details">
    ...
    <div class="locataires-list">
        ...
        <div class="empty-state">
            ...
            <a href="<?php echo e(route('proprietaire.biens')); ?>" class="btn-primary">
                <span>Voir mes biens</span>
                <span class="arrow">→</span>
            </a>
        </div>
        <?php else: ?>
            <?php $__currentLoopData = $locataires; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            <div class="locataire-card">
                <div class="locataire-header">
                    <div class="locataire-info">
                        <div class="locataire-avatar">
                            <img src="<?php echo e($user->photo_profil ? asset('storage/' . $user->photo_profil) : asset('images/default-avatar.png')); ?>" alt="<?php echo e($user->nom); ?>">
                        </div>
                        <div class="locataire-details">
                            <h3><?php echo e($user->nom); ?></h3>
                            <div class="locataire-contact">
                                <span>📧 <?php echo e($user->email); ?></span>
                                <span>📞 <?php echo e($user->indicatif_pays); ?> <?php echo e($user->telephone); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bien-section">
                        ...
                        <div class="bien-details">
                            ...
                            <div class="detail-row">
                                ...
                                <span class="detail-value"><?php echo e($bien->nom); ?></span>
                            </div>
                            <?php else: ?>
                            <div class="detail-row">
                                <span class="detail-label">Type :</span>
                            ...
                            <div class="detail-row">
                                ...
                                <span class="detail-value"><?php echo e($bien->numero_appartement); ?></span>
                            </div>
                            <?php endif; ?>
                            <div class="detail-row">
                                <span class="detail-label">Adresse :</span>
                                <span class="detail-value"><?php echo e($bien->adresse); ?>, <?php echo e($bien->ville); ?></span>
                            </div>
                            <div class="detail-row">
                                <span class="detail-label">Loyer :</span>
                                <span class="detail-value highlight"><?php echo e(number_format($prix, 0, ',', ' ')); ?> FCFA/mois</span>
                            </div>
                            <div class="detail-row">
                                <span class="detail-label">Depuis :</span>
                                <span class="detail-value"><?php echo e($location->date_debut->format('d/m/Y')); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="paiement-section">
                        ...
                        <div class="paiement-details">
                            <div class="paiement-montant">
                                <span class="montant"><?php echo e(number_format($dernierPaiement->montant, 0, ',', ' ')); ?> FCFA</span>
                                <span class="date">le <?php echo e($dernierPaiement->created_at->format('d/m/Y')); ?></span>
                            </div>
                            <div class="paiement-statut">
                                <span class="badge <?php echo e($dernierPaiement->estRecent() ? 'badge-success' : 'badge-warning'); ?>">
                                    <?php echo e($dernierPaiement->estRecent() ? 'Récent' : 'Ancien'); ?>
                ...
                <div class="locataire-actions">
                    <a href="<?php echo e(route('proprietaire.paiements')); ?>?locataire=<?php echo e($user->id); ?>&bien=<?php echo e($location->id_logement); ?>&type=<?php echo e($location->type_logement); ?>"
                    ...
                    <a href="tel:<?php echo e($user->indicatif_pays); ?><?php echo e($user->telephone); ?>"
                    ...
                    <form action="<?php echo e(route('proprietaire.location.terminer', $location->id)); ?>" method="POST" class="action-form"
                          onsubmit="return confirm('Êtes-vous sûr de vouloir résilier le contrat de <?php echo e($user->nom); ?> ?')">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.proprietaire', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/espoir/larav/resources/views/proprietaire/locataires.blade.php ENDPATH**/ ?>