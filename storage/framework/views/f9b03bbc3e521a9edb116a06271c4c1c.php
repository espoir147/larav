...
<body class="proprietaire-body">
    ...
    <header class="proprietaire-header">
        ...
        <div class="header-right">
            <span class="user-name"><?php echo e(Auth::user()->nom); ?></span>
            <img id="headerAvatar" src="<?php echo e(Auth::user()->photo_profil ? asset('storage/' . Auth::user()->photo_profil) . '?v=' . time() : asset('images/default-avatar.jpg')); ?>" alt="Photo profil" class="user-avatar">
        </div>
    </header>
    ...
    <div class="proprietaire-container">
        ...
        <aside class="proprietaire-sidebar" id="sidebar">
            <nav class="proprietaire-nav">
                <a href="<?php echo e(route('proprietaire.dashboard')); ?>" class="nav-link">
                    <span class="icon">📊</span> Tableau de bord
                </a>
                <a href="<?php echo e(route('proprietaire.profil')); ?>" class="nav-link">
                    <span class="icon">👤</span> Profil
                </a>
                <a href="<?php echo e(route('proprietaire.biens')); ?>" class="nav-link">
                    <span class="icon">🏠</span> Mes Biens
                </a>
                <a href="<?php echo e(route('proprietaire.locataires')); ?>" class="nav-link">
                    <span class="icon">👥</span> Mes Locataires
                </a>
                <a href="<?php echo e(route('proprietaire.paiements')); ?>" class="nav-link">
                    <span class="icon">💰</span> Paiements
                </a>
                <a href="<?php echo e(route('proprietaire.payer-loyer')); ?>" class="nav-link">
                    <span class="icon">💳</span> Payer mes loyers
                </a>
                <a href="<?php echo e(route('proprietaire.messagerie')); ?>" class="nav-link">
                    <span class="icon">✉️</span> Messagerie
                </a>
                <a href="<?php echo e(route('proprietaire.annonces')); ?>" class="nav-link">
        ...
        <main class="proprietaire-content">
            <?php echo $__env->yieldContent('proprietaire-content'); ?>
        </main>
    </div>
...
<?php /**PATH /home/espoir/larav/resources/views/layouts/proprietaire.blade.php ENDPATH**/ ?>