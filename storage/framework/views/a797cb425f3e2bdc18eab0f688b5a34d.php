...
<div class="admin-properties-page">
    ...
    <div class="properties-stats-grid">
        <div class="properties-stat-card">
            <h3>⏳ En attente</h3>
            <p class="properties-stat-number" id="stat-en-attente"><?php echo e($stats['en_attente'] ?? 0); ?></p>
        ...
        <div class="properties-stat-card">
            <h3>✅ Approuvés</h3>
            <p class="properties-stat-number" id="stat-approuves"><?php echo e($stats['approuves'] ?? 0); ?></p>
            <div class="properties-stat-breakdown">
        ...
        <div class="properties-stat-card">
            <h3>❌ Rejetés</h3>
            <p class="properties-stat-number" id="stat-rejetes"><?php echo e($stats['rejetes'] ?? 0); ?></p>
            <div class="properties-stat-breakdown">
        ...
        <div class="properties-stat-card">
            <h3>📊 Total</h3>
            <p class="properties-stat-number" id="stat-total"><?php echo e($stats['total'] ?? 0); ?></p>
            <div class="properties-stat-breakdown">
    ...
    <div class="properties-filters-section">
        <form method="GET" action="<?php echo e(route('admin.properties')); ?>" id="filterForm">
            <div class="properties-filters-row">
                <div class="properties-filter-group">
                    ...
                    <select name="type" id="typeFilter" onchange="filterProperties()">
                        ...
                        <option value="maison" <?php echo e(request('type') == 'maison' ? 'selected' : ''); ?>>Maison</option>
                        <option value="appartement" <?php echo e(request('type') == 'appartement' ? 'selected' : ''); ?>>Appartement</option>
                    </select>
                </div>
                ...
                <div class="properties-filter-group">
                    ...
                    <select name="statut" id="statutFilter" onchange="filterProperties()">
                        ...
                        <option value="approuve" <?php echo e(request('statut') == 'approuve' ? 'selected' : ''); ?>>Approuvé</option>
    ...
    <div class="properties-tabs">
        <button class="properties-tab <?php echo e(!request('statut') ? 'active' : ''); ?>" onclick="switchTab('all')">
            Tous les biens
        </button>
        <button class="properties-tab <?php echo e(request('statut') == 'en_attente' ? 'active' : ''); ?>" onclick="switchTab('pending')">
            En attente
            <?php if($stats['en_attente'] ?? 0 > 0): ?>
                <span class="properties-tab-badge"><?php echo e($stats['en_attente']); ?></span>
            <?php endif; ?>
        </button>
        <button class="properties-tab <?php echo e(request('statut') == 'approuve' ? 'active' : ''); ?>" onclick="switchTab('approved')">
            Approuvés
        </button>
        <button class="properties-tab <?php echo e(request('statut') == 'rejete' ? 'active' : ''); ?>" onclick="switchTab('rejected')">
            Rejetés
        </button>
    </div>
...
let filters = {
    type: '<?php echo e(request('type')); ?>',
    ville: '<?php echo e(request('ville')); ?>',
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/espoir/larav/resources/views/admin/properties.blade.php ENDPATH**/ ?>