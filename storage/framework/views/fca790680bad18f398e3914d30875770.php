                    ...
                    <div class="conversation-item <?php echo e($loop->first ? 'active' : ''); ?>"
                        ...
                        <div class="conversation-content">
                            ...
                            <div class="conversation-preview">
                                <p class="preview-text"><?php echo e(Str::limit($dernierMessage->contenu, 60)); ?></p>
                                <?php if($nbBiens > 0): ?>
                ...
                <div class="conversation-split">
                    ...
                    <div class="conversation-properties">
                        <div class="properties-sidebar-header">
                            ...
                            <?php if(!empty($biens)): ?>
                                <span class="biens-count"><?php echo e(count($biens)); ?></span>
                            <?php endif; ?>
                        </div>

                        <div class="properties-sidebar-body">
                            <?php if(!empty($biens)): ?>
                                <div class="properties-list" id="biens-list-<?php echo e($interlocuteur->id); ?>">
                                    <?php $__currentLoopData = $biens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bien): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <div class="property-card <?php echo e($estDejaLocataire ? 'is-locataire' : ''); ?>"
                                             data-bien-type="<?php echo e($bien['type']); ?>"
                                             data-bien-id="<?php echo e($bien['id']); ?>"
                                             data-client-id="<?php echo e($interlocuteur->id); ?>">

                                            <!-- Bannière type -->
                                            <div class="property-card-banner <?php echo e($isMaison ? 'banner-maison' : 'banner-appart'); ?>">
                                                <span class="banner-icon"><?php echo e($isMaison ? '🏠' : '🏢'); ?></span>
                                                <span class="banner-label"><?php echo e($isMaison ? 'Maison' : 'Appartement'); ?></span>
                                            </div>

                                            <!-- Infos -->
                                            <div class="property-card-body">
                                                <h4 class="property-card-name"><?php echo e($bien['nom']); ?></h4>
                                                <p class="property-card-address">
                                                    <span>📍</span> <?php echo e(Str::limit($bien['adresse'], 30)); ?>

                                                </p>

                                                <?php if($estDejaLocataire): ?>
                                                    <p class="property-locataire-text">✅ Déjà locataire</p>
                                                <?php else: ?>
                                                    <button class="btn-accepter"
                                                            onclick="accepterLocataire(<?php echo e($interlocuteur->id); ?>, '<?php echo e($bien['type']); ?>', <?php echo e($bien['id']); ?>, this)">
            ...
            if (document.querySelectorAll('.conversation-item').length === 0) {
                document.getElementById('conversations-list').innerHTML = `
                    <div class="empty-conversations">
                        ...
                        <h3>Aucune conversation</h3>
                        <p>Vous n'avez pas encore échangé avec des locataires ou clients.</p>
                        <a href="<?php echo e(route('proprietaire.biens')); ?>" class="btn-primary">Voir mes biens</a>
                    </div>
                `;
            }
...
<?php echo $__env->make('layouts.proprietaire', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/espoir/larav/resources/views/proprietaire/messagerie.blade.php ENDPATH**/ ?>