...
<div class="client-paiements-page">
    ...
    <div class="filters-section">
        <form method="GET" action="<?php echo e(route('client.paiements')); ?>" class="filters-form">
            <div class="filter-group">
                ...
                <select id="mois" name="mois" class="filter-select">
                    ...
                    <?php $__currentLoopData = $mois; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($m); ?>" <?php echo e($filtreMois == $m ? 'selected' : ''); ?>><?php echo e($m); ?></option>
            ...
            <div class="filter-group">
                ...
                <select id="annee" name="annee" class="filter-select">
                    ...
                    <?php $__currentLoopData = $annees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($a); ?>" <?php echo e($filtreAnnee == $a ? 'selected' : ''); ?>><?php echo e($a); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            ...
            <?php if($filtreMois || $filtreAnnee): ?>
                <a href="<?php echo e(route('client.paiements')); ?>" class="btn-reset">
        ...
        <?php if($filtreMois || $filtreAnnee): ?>
            <div class="filter-info">
                <div class="info-badge">
                    ...
                    <span><strong><?php echo e($paiements->total()); ?></strong> paiement(s) trouvé(s)</span>
                </div>
                <?php if($filtreMois && $filtreAnnee): ?>
                    <div class="info-period">pour <strong><?php echo e($filtreMois); ?> <?php echo e($filtreAnnee); ?></strong></div>
                <?php elseif($filtreMois): ?>
                    <div class="info-period">pour <strong><?php echo e($filtreMois); ?></strong></div>
                <?php elseif($filtreAnnee): ?>
                    <div class="info-period">pour <strong><?php echo e($filtreAnnee); ?></strong></div>
                <?php endif; ?>
                <div class="info-total">
                    <span class="total-label">Total :</span>
                    <span class="total-amount"><?php echo e(number_format($total, 0, ',', ' ')); ?> FCFA</span>
                </div>
            </div>
        <?php endif; ?>
    </div>
    ...
    <?php if($paiements->isEmpty()): ?>
        <div class="empty-state">
            ...
            <p>Vous n'avez effectué aucun paiement<?php echo e($filtreMois || $filtreAnnee ? ' pour cette période' : ''); ?>.</p>
            <?php if($filtreMois || $filtreAnnee): ?>
                <a href="<?php echo e(route('client.paiements')); ?>" class="btn-primary">
    ...
    <?php else: ?>
                ...
                <div class="paiement-card">
                    <div class="paiement-header">
                        <div class="paiement-amount">
                            ...
                            <span class="date"><?php echo e(\Carbon\Carbon::parse($paiement->date_paiement)->format('d/m/Y')); ?></span>
                        </div>
                    ...
                    <div class="paiement-body">
                        <div class="property-info">
                            <h4 class="property-name">
                                <?php if($paiement->maison): ?>
                                    <?php echo e($paiement->maison->nom); ?>

                                <?php elseif($paiement->appartement): ?>
                                    Appartement <?php echo e($paiement->appartement->numero_appartement); ?>
                            ...
                            <p class="property-address">
                                <?php if($paiement->maison): ?>
                                    <?php echo e($paiement->maison->adresse); ?>, <?php echo e($paiement->maison->ville); ?>

                                <?php elseif($paiement->appartement): ?>
                                    <?php echo e($paiement->appartement->adresse); ?>, <?php echo e($paiement->appartement->ville); ?>
                        ...
                        <div class="paiement-details">
                            <div class="detail-chip">
                                ...
                                <span><?php echo e($paiement->mois_paye); ?> <?php echo e($paiement->annee_paye); ?></span>
                            </div>
                            <div class="detail-chip">
                                <span class="chip-icon">📱</span>
                                <span><?php echo e($paiement->operateur->nom ?? 'Mobile Money'); ?></span>
                            </div>
                            <div class="detail-chip">
                                <span class="chip-icon">🔖</span>
                                <span>Ref: <?php echo e($paiement->reference_transaction); ?></span>
                            </div>
                        </div>
                    </div>

                    <div class="paiement-footer">
                        <button class="btn-action btn-view" onclick="showPaiementDetails(<?php echo e($paiement->id); ?>)">
                            <span class="btn-icon">👁️</span>
                            <span>Détails</span>
                        </button>
                        <a href="<?php echo e(route('client.paiements.telecharger', $paiement->id)); ?>" class="btn-action btn-download">
                            <span class="btn-icon">📥</span>
                            <span>Reçu PDF</span>
                        </a>
                    </div>
        ...
        <?php if($paiements->hasPages()): ?>
            <div class="pagination-wrapper">
                <?php echo e($paiements->links('vendor.pagination.custom')); ?>
...
<?php echo $__env->make('layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/espoir/larav/resources/views/client/paiements.blade.php ENDPATH**/ ?>