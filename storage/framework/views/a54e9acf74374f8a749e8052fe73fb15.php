    ...
    <div class="stats-grid">
        <div class="stat-card">
            ...
            <div class="stat-content">
                ...
                <p class="stat-number"><?php echo e($totalBiens); ?></p>
                <div class="stat-details">
                    <span class="detail-item">🏡 Maisons: <?php echo e($maisonsCount); ?></span>
                    <span class="detail-item">🏢 Apparts: <?php echo e($appartementsCount); ?></span>
                </div>
            </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-content">
                ...
                <p class="stat-number"><?php echo e($locatairesActifs); ?></p>
                <div class="stat-details">
                    <span class="detail-item">🏡 Maisons: <?php echo e($locatairesMaisons); ?></span>
                    <span class="detail-item">🏢 Apparts: <?php echo e($locatairesApparts); ?></span>
                </div>
            </div>
            <div class="stat-glow"></div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-content">
                ...
                <p class="stat-number"><?php echo e(number_format($revenusMensuels, 0, ',', ' ')); ?> FCFA</p>
                <div class="stat-details">
                    <span class="detail-item">📅 Ce mois</span>
                    <span class="detail-item">📊 Taux occupation: <?php echo e($tauxOccupation); ?>%</span>
                </div>
            </div>
            <div class="stat-glow"></div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-content">
                ...
                <p class="stat-number"><?php echo e($messagesNonLus); ?></p>
                <div class="stat-details">
                    <span class="detail-item">⏳ Demandes: <?php echo e($demandesAttente); ?></span>
                    <span class="detail-item">⚠️ Urgent: <?php echo e($messagesUrgents); ?></span>
                </div>
            </div>
            <div class="stat-glow"></div>
        </div>
    ...
    <div class="content-grid">
        ...
        <div class="content-card">
            <div class="card-header">
                ...
                <a href="<?php echo e(route('proprietaire.paiements')); ?>" class="view-all">
                    <span>Voir tout</span>
            ...
            <div class="card-content">
                ...
                <div class="paiement-item">
                    <div class="paiement-info">
                        <strong><?php echo e($paiement->utilisateur->nom); ?></strong>
                        <span class="montant"><?php echo e(number_format($paiement->montant, 0, ',', ' ')); ?> FCFA</span>
                    </div>
                    <div class="paiement-meta">
                        <span class="bien"><?php echo e($paiement->maison->nom ?? $paiement->appartement->numero_appartement); ?></span>
                        <span class="date"><?php echo e($paiement->created_at->format('d/m/Y')); ?></span>
                    </div>
                </div>
        ...
        <div class="content-card">
            <div class="card-header">
                ...
                <a href="<?php echo e(route('proprietaire.locataires')); ?>" class="view-all">
                    <span>Voir tout</span>
                    <span class="arrow">→</span>
                </a>
            </div>
            <div class="card-content">
                <?php $__empty_1 = true; $__currentLoopData = $demandesLocation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $demande): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="demande-item">
                    <div class="demande-info">
                        <strong><?php echo e($demande->utilisateur->nom); ?></strong>
                        <span class="badge badge-<?php echo e($demande->statut); ?>"><?php echo e($demande->statut); ?></span>
                    </div>
                    <div class="demande-meta">
                        <span class="bien"><?php echo e($demande->type_logement); ?> - #<?php echo e($demande->id_logement); ?></span>
                        <span class="date"><?php echo e($demande->created_at->diffForHumans()); ?></span>
                    </div>
                    <div class="demande-actions">
                        <button class="btn-accept" onclick="accepterDemande(<?php echo e($demande->id); ?>)">
                            <span class="btn-icon">✅</span>
                            <span>Accepter</span>
                        </button>
                        <button class="btn-refuse" onclick="refuserDemande(<?php echo e($demande->id); ?>)">
                            <span class="btn-icon">❌</span>
                            <span>Refuser</span>
                        </button>
                    </div>
        ...
        <div class="content-card">
            <div class="card-header">
                ...
                <a href="<?php echo e(route('proprietaire.messagerie')); ?>" class="view-all">
                    <span>Voir tout</span>
                    <span class="arrow">→</span>
                </a>
            </div>
            <div class="card-content">
                <?php $__empty_1 = true; $__currentLoopData = $derniersMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="message-item <?php echo e(!$message->lu ? 'unread' : ''); ?>">
                    ...
                    <div class="message-content">
                        ...
                        <p class="message-preview"><?php echo e(Str::limit($message->contenu, 50)); ?></p>
...
<?php echo $__env->make('layouts.proprietaire', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/espoir/larav/resources/views/proprietaire/dashboard.blade.php ENDPATH**/ ?>