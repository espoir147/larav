    ...
    <div class="users-table-container">
        <table class="admin-table">
            ...
            <tbody>
                ...
                <tr data-status="<?php echo e($user->statut); ?>">
                    <td class="user-info">
                        <img src="<?php echo e($user->photo_profil ? asset('storage/' . $user->photo_profil) : asset('images/default-avatar.jpg')); ?>" alt="Photo profil" class="user-avatar">
                        <div class="user-details">
                            <strong><?php echo e($user->nom); ?></strong>
                            <small>ID: <?php echo e($user->id); ?></small>
                        </div>
                    </td>

                    <td class="contact-info">
                        <div><?php echo e($user->email); ?></div>
                        <small><?php echo e($user->indicatif_pays); ?><?php echo e($user->telephone); ?></small>
                    </td>

                    <td>
                        <span class="badge badge-type"><?php echo e($user->type); ?></span>
                    </td>

                    <td>
                        <span class="badge badge-<?php echo e($user->statut); ?>">
                            <?php echo e($user->statut); ?>
                    ...
                    <td class="actions-cell">
                        <div class="action-buttons">
                            <?php if($user->statut == 'en_attente'): ?>
                                <button class="action-btn btn-success" onclick="validateUser(<?php echo e($user->id); ?>)" title="Valider">
                                    <span class="btn-icon">✅</span>
                                    <span class="btn-text">Valider</span>
                                </button>
                                <button class="action-btn btn-danger" onclick="rejectUser(<?php echo e($user->id); ?>)" title="Rejeter">
                                    <span class="btn-icon">❌</span>
                            ...
                            <?php if($user->statut == 'actif'): ?>
                                <button class="action-btn btn-warning" onclick="blockUser(<?php echo e($user->id); ?>)" title="Bloquer">
                                    <span class="btn-icon">🚫</span>
                            ...
                            <?php if($user->statut == 'bloque'): ?>
                                <button class="action-btn btn-success" onclick="unblockUser(<?php echo e($user->id); ?>)" title="Débloquer">
                                    <span class="btn-icon">🔓</span>
                                    <span class="btn-text">Débloquer</span>
                                </button>
                            <?php endif; ?>

                            <button class="action-btn btn-info" onclick="showUserDetails(<?php echo e($user->id); ?>)" title="Voir détails">
                                <span class="btn-icon">👀</span>
                                <span class="btn-text">Voir</span>
                            </button>

                            <button class="action-btn btn-danger" onclick="confirmDelete(<?php echo e($user->id); ?>)" title="Supprimer">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/espoir/larav/resources/views/admin/users.blade.php ENDPATH**/ ?>