    ...
    <header class="header">
        <div class="container flex-between">
            ...
            <nav class="nav-desktop">
                ...
                <a href="<?php echo e(route('guide')); ?>" class="nav-link">
            ...
            <div class="header-actions">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="btn-connexion">
                        <i class="fas fa-user-circle"></i> Mon Compte
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="btn-connexion">
        ...
        <div class="mobile-menu" id="mobileMenu">
            ...
            <div class="mobile-menu-content">
                ...
                <a href="<?php echo e(route('guide')); ?>" class="mobile-nav-link">
                    <i class="fas fa-book"></i> Guide
                </a>
                <hr class="menu-divider">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="mobile-nav-link">
                        <i class="fas fa-user-circle"></i> Mon Compte
                    </a>
                <?php else: ?>
            ...
            <div class="hero-content">
                ...
                <div class="trust-indicators">
                    <div class="trust-item">
                        <span class="trust-number"><?php echo e($maisons->count() + $appartements->count()); ?>+</span>
                ...
                <div class="search-container">
                    <form action="<?php echo e(route('property.search')); ?>" method="GET" class="search-form">
            ...
            <?php else: ?>
                <div class="properties-grid">
                    <?php $__currentLoopData = $maisons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $maison): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="property-card" data-property-id="<?php echo e($maison->id); ?>" data-type="maison">
                            <!-- Badge Disponible -->
                            ...
                            <div class="property-image-container">
                                <img src="<?php echo e($maison->first_photo); ?>"
                                     ...
                                     onclick="openGallery(<?php echo e(json_encode($maison->photos_array)); ?>)">
                                <div class="property-image-overlay">
                                    <button class="view-gallery-btn" onclick="openGallery(<?php echo e(json_encode($maison->photos_array)); ?>)">
                            ...
                            <div class="property-content">
                                ...
                                <div class="property-location">
                                    <i class="fas fa-map-marker-alt"></i>
                                    <span><?php echo e($maison->ville); ?>, <?php echo e($maison->adresse); ?></span>
                                </div>

                                <!-- Titre -->
                                <h3 class="property-title"><?php echo e($maison->nom); ?></h3>
                                ...
                                <div class="property-features">
                                    ...
                                    <div class="feature">
                                        <i class="fas fa-<?php echo e($maison->salon ? 'check' : 'times'); ?>"></i>
                                        <span><?php echo e($maison->salon ? 'Avec salon' : 'Sans salon'); ?></span>
                                    </div>
                                    <div class="feature">
                                        <i class="fas fa-home"></i>
                                        <span><?php echo e(ucfirst($maison->type)); ?></span>
                                    </div>
                                </div>

                                <!-- Description courte -->
                                <p class="property-description">
                                    <?php echo e(Str::limit($maison->description, 100)); ?>

                                </p>

                                <!-- Prix -->
                                <div class="property-price">
                                    <span class="price-amount"><?php echo e(number_format($maison->prix, 0, '', ' ')); ?> FCFA</span>
                                ...
                                <div class="property-actions">
                                    ...
                                    <button class="btn-details"
                                            onclick="openPropertyModal('maison', <?php echo e($maison->id); ?>)">
                                    ...
                                    <?php if(auth()->guard()->check()): ?>
                                        <button class="btn-contact"
                                                ...
                                                data-proprietaire-id="<?php echo e($maison->proprietaire->id); ?>"
                                                data-logement-id="<?php echo e($maison->id); ?>"
            ...
            <?php else: ?>
                <div class="properties-grid">
                    <?php $__currentLoopData = $appartements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appartement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="property-card" data-property-id="<?php echo e($appartement->id); ?>" data-type="appartement">
                            <!-- Badge Disponible -->
                            <div class="property-badge available">
                                <i class="fas fa-check-circle"></i> Disponible
                            </div>
                            ...
                            <div class="property-image-container">
                                <img src="<?php echo e($appartement->first_photo); ?>"
                                     ...
                                     class="property-image"
                                     onclick="openGallery(<?php echo e(json_encode($appartement->photos_array)); ?>)">
                                <div class="property-image-overlay">
                                    <button class="view-gallery-btn" onclick="openGallery(<?php echo e(json_encode($appartement->photos_array)); ?>)">
                                        <i class="fas fa-images"></i> Voir photos
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="property-content">
                                ...
                                <div class="property-location">
                                    <i class="fas fa-map-marker-alt"></i>
                                    <span><?php echo e($appartement->ville); ?>, <?php echo e($appartement->adresse); ?></span>
                                </div>

                                <!-- Titre -->
                                <h3 class="property-title">Appartement <?php echo e($appartement->numero_appartement); ?></h3>
                                ...
                                <div class="property-features">
                                    ...
                                    <div class="feature">
                                        <i class="fas fa-<?php echo e($appartement->salon ? 'check' : 'times'); ?>"></i>
                                        <span><?php echo e($appartement->salon ? 'Avec salon' : 'Sans salon'); ?></span>
                                    </div>
                                    <div class="feature">
                                        <i class="fas fa-home"></i>
                                        <span><?php echo e(ucfirst($appartement->type)); ?></span>
                                    </div>
                                </div>

                                <!-- Description courte -->
                                <p class="property-description">
                                    <?php echo e(Str::limit($appartement->description, 100)); ?>

                                </p>

                                <!-- Prix -->
                                <div class="property-price">
                                    <span class="price-amount"><?php echo e(number_format($appartement->prix_mensuel, 0, '', ' ')); ?> FCFA</span>
                                    <span class="price-period">/ mois</span>
                                </div>
                                ...
                                <div class="property-actions">
                                    <!-- Bouton Détails -->
                                    <button class="btn-details"
                                            onclick="openPropertyModal('appartement', <?php echo e($appartement->id); ?>)">
                                        <i class="fas fa-search"></i> Détails
                                    </button>
                                    ...
                                    <?php if(auth()->guard()->check()): ?>
                                        <button class="btn-contact"
                                                onclick="envoyerMessageEtRediriger(event, this)"
                                                data-proprietaire-id="<?php echo e($appartement->proprietaire->id); ?>"
                                                data-logement-id="<?php echo e($appartement->id); ?>"
        ...
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-links">
                    ...
                    <a href="<?php echo e(route('guide')); ?>">Guide</a>
            ...
            <div class="footer-bottom">
                &copy; <?php echo e(date('Y')); ?> ImmoLoc. Tous droits réservés.
            </div>
        </div>
    </footer>
...
<?php /**PATH /home/espoir/larav/resources/views/home.blade.php ENDPATH**/ ?>