...
<body class="client-body">
    ...
    <header class="client-header">
        ...
        <div class="header-right">
            ...
            <img src="<?php echo e(Auth::user()->photo_profil ? asset('storage/' . Auth::user()->photo_profil) : asset('images/default-avatar.png')); ?>"
                 alt="Photo profil"
                 class="user-avatar"
                 id="headerAvatar">
        </div>
    ...
    <div class="client-container">
        ...
        <aside class="client-sidebar" id="sidebar">
            <nav class="client-nav">
                <a href="<?php echo e(route('client.dashboard')); ?>" class="nav-link">
                    <span class="icon">📊</span> Tableau de bord
                </a>
                <a href="<?php echo e(route('client.profil')); ?>" class="nav-link">
                    <span class="icon">👤</span> Mon Profil
                </a>
                <a href="<?php echo e(route('client.locations')); ?>" class="nav-link">
                    <span class="icon">🏠</span> Mes Locations
                </a>
                <a href="<?php echo e(route('client.paiements')); ?>" class="nav-link">
                    <span class="icon">💰</span> Mes Paiements
                </a>
                <a href="<?php echo e(route('client.messagerie')); ?>" class="nav-link">
                    <span class="icon">✉️</span> Messagerie
                </a>
                <a href="<?php echo e(route('client.favoris')); ?>" class="nav-link">
...
<?php /**PATH /home/espoir/larav/resources/views/layouts/client.blade.php ENDPATH**/ ?>