    ...
    <div class="profile-container">
        ...
        <div class="profile-photo-column">
            ...
            <div class="quick-nav-card">
                ...
                <a href="<?php echo e(route('proprietaire.biens')); ?>" class="quick-nav-item">
                    <span class="nav-icon">🏠</span>
                    <span class="nav-text">Mes biens</span>
                    <span class="nav-arrow">→</span>
                </a>
                <a href="<?php echo e(route('proprietaire.locataires')); ?>" class="quick-nav-item">
                    <span class="nav-icon">👥</span>
                    <span class="nav-text">Mes locataires</span>
                    <span class="nav-arrow">→</span>
                </a>
                <a href="<?php echo e(route('proprietaire.paiements')); ?>" class="quick-nav-item">
                    <span class="nav-icon">💰</span>
        ...
        <div class="profile-form-column">
            <form id="profile-form" action="<?php echo e(route('proprietaire.profil')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text"
                                   id="nom"
                                   name="nom"
                                   value="<?php echo e(old('nom', $proprietaire->nom)); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <input type="email"
                                   id="email"
                                   name="email"
                                   value="<?php echo e(old('email', $proprietaire->email)); ?>"
                        ...
                        <div class="form-group full-width">
                            ...
                            <div class="phone-group">
                                <select name="indicatif_pays" class="phone-code">
                                    <option value="+225" <?php echo e($proprietaire->indicatif_pays == '+225' ? 'selected' : ''); ?>>+225 (CI)</option>
                                    <option value="+33" <?php echo e($proprietaire->indicatif_pays == '+33' ? 'selected' : ''); ?>>+33 (FR)</option>
                                    <option value="+229" <?php echo e($proprietaire->indicatif_pays == '+229' ? 'selected' : ''); ?>>+229 (BJ)</option>
                                    <option value="+226" <?php echo e($proprietaire->indicatif_pays == '+226' ? 'selected' : ''); ?>>+226 (BF)</option>
                                    <option value="+223" <?php echo e($proprietaire->indicatif_pays == '+223' ? 'selected' : ''); ?>>+223 (ML)</option>
                                </select>
                                <input type="tel"
                                       name="telephone"
                                       value="<?php echo e(old('telephone', $proprietaire->telephone)); ?>"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.confirmPhoto = function() {
        ...
        fetch('<?php echo e(route("proprietaire.profil.update")); ?>', {
            method: 'POST',
            body: formData,
            headers: {
...
<?php echo $__env->make('layouts.proprietaire', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/espoir/larav/resources/views/proprietaire/profil.blade.php ENDPATH**/ ?>