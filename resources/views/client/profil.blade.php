    ...
    <div class="profile-container">
        ...
        <div class="profile-sidebar">
            ...
            <div class="quick-nav-card">
                ...
                <a href="{{ route('client.locations') }}" class="quick-nav-item">
                    <span class="nav-icon">🏠</span>
                    <span class="nav-text">Mes locations</span>
                    <span class="nav-arrow">→</span>
                </a>
                <a href="{{ route('client.paiements') }}" class="quick-nav-item">
                    <span class="nav-icon">💰</span>
                    <span class="nav-text">Mes paiements</span>
                    <span class="nav-arrow">→</span>
                </a>
                <a href="{{ route('client.messagerie') }}" class="quick-nav-item">
        ...
        <div class="profile-form">
            <form id="profile-form" action="{{ route('client.profil') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="form-group full-width">
                            ...
                            <div class="phone-group">
                                <select name="indicatif_pays" class="phone-code">
                                    <option value="+225" {{ $client->indicatif_pays == '+225' ? 'selected' : '' }}>+225 (CI)</option>
                                    <option value="+33" {{ $client->indicatif_pays == '+33' ? 'selected' : '' }}>+33 (FR)</option>
                                    <option value="+229" {{ $client->indicatif_pays == '+229' ? 'selected' : '' }}>+229 (BJ)</option>
                                    <option value="+226" {{ $client->indicatif_pays == '+226' ? 'selected' : '' }}>+226 (BF)</option>
                                    <option value="+223" {{ $client->indicatif_pays == '+223' ? 'selected' : '' }}>+223 (ML)</option>
                                </select>
                                <input type="tel"
                                       name="telephone"
