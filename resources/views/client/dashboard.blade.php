    ...
    <div class="client-stats-grid">
        <div class="client-stat-card">
            ...
            <div class="stat-content">
                ...
                <p class="stat-number">{{ $locationsActives ?? 0 }}</p>
        ...
        <div class="client-stat-card">
            ...
            <div class="stat-content">
                ...
                <p class="stat-number">{{ $prochainPaiement ?? 'Aucun' }}</p>
                <div class="stat-details">
        ...
        <div class="client-stat-card">
            ...
            <div class="stat-content">
                ...
                <p class="stat-number">{{ $messagesNonLus ?? 0 }}</p>
                <div class="stat-details">
                    <span>À lire</span>
                </div>
            </div>
        ...
        <div class="client-stat-card">
            ...
            <div class="stat-content">
                <h3>Favoris</h3>
                <p class="stat-number">{{ $favorisCount ?? 0 }}</p>
                <div class="stat-details">
    ...
    <div class="client-content-grid">
        ...
        <div class="client-content-card">
            <div class="card-header">
                ...
                <a href="{{ route('client.locations') }}" class="view-all">
                    <span>Voir tout</span>
                    <span class="arrow">→</span>
                </a>
            </div>
            <div class="card-content">
                @forelse($locationsEnCours as $location)
                <div class="location-item">
                    <div class="location-info">
                        <strong>{{ $location->maison->nom ?? $location->appartement->numero_appartement }}</strong>
                        <span class="badge {{ $location->type_logement === 'maison' ? 'badge-info' : 'badge-success' }}">
                            {{ $location->type_logement === 'maison' ? 'Maison' : 'Appartement' }}
                        </span>
                    </div>
                    <div class="location-meta">
                        <span class="meta-date">
                            <span class="meta-icon">📅</span>
                            Début: {{ $location->date_debut->format('d/m/Y') }}
                        </span>
                        <span class="meta-location">
                            <span class="meta-icon">📍</span>
                            {{ $location->maison->ville ?? $location->appartement->ville }}
                        </span>
                    </div>
                </div>
                @empty
                <div class="empty-state">
                    ...
                    <a href="{{ route('home') }}" class="empty-action">
        ...
        <div class="client-content-card">
            <div class="card-header">
                ...
                <a href="{{ route('client.paiements') }}" class="view-all">
                    <span>Voir tout</span>
                    <span class="arrow">→</span>
                </a>
            </div>
            <div class="card-content">
                ...
                <div class="paiement-item">
                    <div class="paiement-info">
                        <strong>{{ $paiement->maison->nom ?? $paiement->appartement->numero_appartement }}</strong>
                        <span class="paiement-montant">{{ number_format($paiement->montant, 0, ',', ' ') }} FCFA</span>
                    </div>
                    <div class="paiement-meta">
                        ...
                        <small class="paiement-ref">Réf: {{ $paiement->reference_transaction }}</small>
                    </div>
                </div>
                @empty
                <div class="empty-state">
        ...
        <div class="client-content-card">
            <div class="card-header">
                ...
                <a href="{{ route('client.messagerie') }}" class="view-all">
                    <span>Voir tout</span>
                    <span class="arrow">→</span>
                </a>
            </div>
            <div class="card-content">
                ...
                <div class="message-item {{ $message->destinataire_id == Auth::id() && !$message->lu ? 'unread' : '' }}">
                    <div class="message-avatar">
                        <img src="{{ $message->expediteur->photo_profil ? asset('storage/' . $message->expediteur->photo_profil) : asset('images/default-avatar.png') }}"
                             alt="Photo de {{ $message->expediteur->nom }}">
                    </div>
                    <div class="message-content">
                        ...
                        <p class="message-preview">{{ Str::limit($message->contenu, 60) }}</p>
