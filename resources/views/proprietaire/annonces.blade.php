...
<div class="proprio-annonces-page">
    ...
    <div id="form-maison" class="form-section" style="display: none;">
        ...
        <form action="{{ route('proprietaire.maison.store') }}" method="POST" enctype="multipart/form-data" class="property-form">
            @csrf
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <select id="salon"
                            name="salon"
                            class="form-select @error('salon') error @enderror"
                            required>
                        <option value="1" {{ old('salon', '1') == '1' ? 'selected' : '' }}>Oui</option>
                ...
                <div class="form-group">
                    ...
                    <select id="type_maison"
                        ...
                        <option value="sanitaires" {{ old('type') == 'sanitaires' ? 'selected' : '' }}>Avec sanitaires</option>
                    </select>
                    @error('type')
                    <div class="error-message">❌ {{ $message }}</div>
                    @enderror
                    ...
                    <div class="coordinates-grid">
                        <div class="coordinate-field">
                            ...
                            <input type="text"
                                   id="latitude_maison"
                                   name="latitude"
                                   class="form-input readonly @error('latitude') error @enderror"
                                   value="{{ old('latitude', '6.372300') }}"
                                   readonly>
                            @error('latitude')
                            <div class="error-message">❌ {{ $message }}</div>
                            @enderror
                        ...
                        <div class="coordinate-field">
                            ...
                            <input type="text"
                                   id="longitude_maison"
                                   name="longitude"
                                   class="form-input readonly @error('longitude') error @enderror"
                                   value="{{ old('longitude', '2.364700') }}"
                                   readonly>
                            @error('longitude')
                            <div class="error-message">❌ {{ $message }}</div>
                            @enderror
                ...
                <div class="form-group full-width">
                    ...
                    <div class="file-input-wrapper">
                        <input type="file"
                               id="photos_maison"
                               name="photos[]"
                               class="file-input @error('photos') error @enderror @error('photos.*') error @enderror"
                               multiple
                               accept="image/*"
                               required>
    ...
    <div id="form-appartement" class="form-section" style="display: none;">
        ...
        <form action="{{ route('proprietaire.appartement.store') }}" method="POST" enctype="multipart/form-data" class="property-form">
            @csrf
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text"
                           ...
                           class="form-input @error('numero_appartement') error @enderror"
                           value="{{ old('numero_appartement') }}"
                           placeholder="Ex: Appartement 101, Résidence A..."
                           required>
                    @error('numero_appartement')
                    <div class="error-message">❌ {{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number"
                           id="prix_mensuel"
                           name="prix_mensuel"
                           class="form-input @error('prix_mensuel') error @enderror"
