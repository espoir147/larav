...
<body class="admin-body">
    ...
    <header class="admin-header">
        ...
        <div class="admin-header-right">
            <span class="admin-name">{{ Auth::user()->nom }}</span>
            <img src="{{ Auth::user()->photo_profil ? asset('storage/' . Auth::user()->photo_profil) : asset('images/default-avatar.jpg') }}" alt="Photo profil" class="user-avatar">
        </div>
    </header>
    ...
    <div class="admin-container">
        ...
        <aside class="admin-sidebar">
            <nav class="admin-nav">
                ...
                <a href="{{ route('admin.transactions') }}" class="admin-nav-link">
                    💰 Transactions
                </a>
                <a href="{{ route('admin.logs') }}" class="admin-nav-link">
                    📝 Journal
                </a>
                <a href="{{ route('admin.profil') }}" class="admin-nav-link">
                    ⚙️ Profil
                </a>
