...
<body>
    ...
    <div class="register-page">
        <div class="register-card">
            ...
            <!-- Formulaire -->
            <form action="{{ route('register') }}" method="POST" enctype="multipart/form-data" class="register-form" id="registerForm">
                @csrf
                    ...
                    <div class="form-column">
                        <div class="form-group">
                            ...
                            <select id="type" name="type" class="form-select">
                                ...
                                <option value="proprietaire" {{ old('type') == 'proprietaire' ? 'selected' : '' }}>
                                    Propriétaire
                                </option>
                            </select>
                        </div>
