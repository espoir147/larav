...
<div class="admin-profil-page">
    ...
    <div class="profil-container">
        ...
        <div class="profil-photo-column">
            <div class="photo-card">
                <div class="photo-current" id="photoCurrent" onclick="document.getElementById('photoInput').click()">
                    <img id="currentPhoto" src="{{ Auth::user()->photo_profil ? asset('storage/' . Auth::user()->photo_profil) : asset('images/default-avatar.jpg') }}" alt="Photo profil">
        ...
        <div class="profil-info-column">
            ...
            <form action="{{ route('admin.profil') }}" method="POST" id="profilForm">
                @csrf
                @method('PUT')
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" id="indicatif_pays" name="indicatif_pays"
                                   value="{{ old('indicatif_pays', Auth::user()->indicatif_pays ?? '+229') }}"
                ...
                <div class="info-section">
                    ...
                    <div class="system-info">
                        <div class="info-item">
                            ...
                            <span class="info-value">{{ Auth::user()->created_at->format('d/m/Y à H:i') }}</span>
                        </div>
                        <div class="info-item">
                            <span class="info-label">Dernière modification :</span>
                            <span class="info-value">{{ Auth::user()->updated_at->format('d/m/Y à H:i') }}</span>
                        </div>
                        <div class="info-item">
